...
if ( ! function_exists( 'mn_get_attachment_image_url' ) ) {
	/**
	 * Get the URL of an image attachment.
	 *
	 * @since Mtaandao 4.4.0
	 *
...
function icon_picker_get_icon_url( $type, $id, $size = 'thumbnail' ) {
	...
	return mn_get_attachment_image_url( $id, $size, false );
}
...
function icon_picker_field( $args, $echo = true ) {
	...
	$args['value'] = mn_parse_args( $args['value'], $defaults['value'] );
