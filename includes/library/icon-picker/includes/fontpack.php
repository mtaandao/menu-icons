...
final class Icon_Picker_Fontpack {
	...
	protected function __construct() {
		 ...
		 *
		 * @since 0.1.0
		 * @param string $dir Directory path, defaults to /main/fontpacks.
		 */
		$this->dir = apply_filters( 'icon_picker_fontpacks_dir_path', MN_CONTENT_DIR . '/fontpacks' );
		 ...
		 *
		 * @since 0.4.0
		 * @param string $url URL path, defaults to /main/fontpacks
		 */
		$this->url = apply_filters( 'icon_picker_fontpacks_dir_url', MN_CONTENT_URL . '/fontpacks' );
