...
final class Icon_Picker {
	...
	protected function __construct( $args = array() ) {
		...
		load_textdomain( 'icon-picker', MN_LANG_DIR . "/icon-picker/icon-picker-{$locale}.mo" );
		load_plugin_textdomain( 'icon-picker', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );

		add_action( 'mn_loaded', array( $this, 'init' ) );
	}
	 ...
	 *
	 * @since   0.2.0
	 * @mn_hook filter  cmb_field_types
