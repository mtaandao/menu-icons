		...
		?>
			<div class="taxonomydiv">
				...
				<div id="menu-icons-settings-extensions" class="tabs-panel _extensions">
					...
					<ul>
						<li><a target="_blank" href="http://mtaandao.org/plugins/menu-icons-icomoon/">IcoMoon</a></li>
					</ul>
				</div>
			</div>
			...
			array(
				'text'           => array(
					...
					'settingsInfo' => sprintf(
						...
						'<a target="_blank" href="http://mtaandao.org/plugins/simple-custom-css/">Simple Custom CSS</a>'
					),
				),
