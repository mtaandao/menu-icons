...
mn.media.model.MenuIconsItemSettingField = require( './models/item-setting-field.js' );
mn.media.model.MenuIconsItemSettings = require( './models/item-settings.js' );
mn.media.model.MenuIconsItem = require( './models/item.js' );

mn.media.view.MenuIconsItemSettingField = require( './views/item-setting-field.js' );
mn.media.view.MenuIconsItemSettings = require( './views/item-settings.js' );
mn.media.view.MenuIconsItemPreview = require( './views/item-preview.js' );
mn.media.view.MenuIconsSidebar = require( './views/sidebar.js' );
mn.media.view.MediaFrame.MenuIcons = require( './views/frame.js' );
...
/**
 * mn.media.model.MenuIconsItemSettingField
 *
 * @class
...
/**
 * mn.media.model.MenuIconsItemSettings
 *
 * @class
 * @augments Backbone.Collection
 */
var MenuIconsItemSettings = Backbone.Collection.extend({
	model: mn.media.model.MenuIconsItemSettingField
});
...
/**
 * mn.media.view.MediaFrame.MenuIcons
 *
 * @class
 * @augments mn.media.view.MediaFrame.IconPicker
 ...
 */
var MenuIcons = mn.media.view.MediaFrame.IconPicker.extend({
	initialize: function() {
		this.menuItems = new Backbone.Collection( [], {
			model: mn.media.model.MenuIconsItem
		});

		mn.media.view.MediaFrame.IconPicker.prototype.initialize.apply( this, arguments );
...
/**
 * mn.media.view.MenuIconsItemPreview
 *
 * @class
 * @augments mn.media.View
 * @augments mn.Backbone.View
 * @augments Backbone.View
 */
var MenuIconsItemPreview = mn.media.View.extend({
	tagName:   'p',
	...
	initialize: function() {
		mn.media.View.prototype.initialize.apply( this, arguments );
	...
	render: function() {
		...
		this.template = mn.media.template( template );
...
/**
 * mn.media.view.MenuIconsItemSettingField
 *
 * @class
 * @augments mn.media.View
 * @augments mn.Backbone.View
 * @augments Backbone.View
 */
MenuIconsItemSettingField = mn.media.View.extend({
	tagName:   'label',
	className: 'setting',
	events:    {
	...
	initialize: function() {
		...
		this.template = mn.media.template( 'menu-icons-settings-field-' + this.model.get( 'type' ) );
		this.model.on( 'change', this.render, this );
	},
...
/**
 * mn.media.view.MenuIconsItemSettings
 *
 * @class
 ...
 * @augments Backbone.View
 */
var MenuIconsItemSettings = mn.media.view.PriorityList.extend({
	...
	createField: function( model ) {
		var field = new mn.media.view.MenuIconsItemSettingField({
			item:       this.model,
			model:      model,
...
/**
 * mn.media.view.MenuIconsSidebar
 *
 * @class
 * @augments mn.media.view.IconPickerSidebar
 * @augments mn.media.view.Sidebar
 * @augments mn.media.view.PriorityList
 * @augments mn.media.View
 * @augments mn.Backbone.View
 * @augments Backbone.View
 */
var MenuIconsSidebar = mn.media.view.IconPickerSidebar.extend({
	initialize: function() {
		var title = new mn.media.View({
			tagName:  'h3',
			priority: -10
		});

		var info = new mn.media.View({
			tagName:   'p',
			className: '_info',
			priority:  1000
		});

		mn.media.view.IconPickerSidebar.prototype.initialize.apply( this, arguments );
	...
	createPreview: function() {
		...
		self.set( 'preview', new mn.media.view.MenuIconsItemPreview({
			controller: frame,
			model:      frame.target,
			priority:   80
		}) );
	...
	createSettings: function() {
		...
		this.set( 'settings', new mn.media.view.MenuIconsItemSettings({
			controller: this.controller,
			collection: new mn.media.model.MenuIconsItemSettings( fields ),
			model:      frame.target,
...
miPicker = {
	...
	frame: null,
	target: new mn.media.model.IconPickerTarget(),
	...
	createFrame: function() {
		miPicker.frame = new mn.media.view.MediaFrame.MenuIcons({
			target:      miPicker.target,
			ipTypes:     _.filter( iconPicker.types, miPicker.typesFilter ),
			SidebarView: mn.media.view.MenuIconsSidebar
		});
	},
	...
	updateField: function( e ) {
		...
		if ( miPicker.templates[ type ] ) {
			...
			template = miPicker.templates[ type ] = mn.template( 'menu-icons-item-field-preview-' + iconPicker.types[ type ].templateId );
		}
